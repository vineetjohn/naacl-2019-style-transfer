...
\begin{table*}[!t]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{|l||c|c|c|c||c|c|c|c| }
			\hline
			\tabc{3}{Model}                                & \multicolumn{4}{c||}{\textbf{Yelp Dataset}} & \multicolumn{4}{c|}{\textbf{Amazon Dataset}}                                                                                                                                                                                              \\ \cline{2-9}
			                                               & \multirow{2}{*}{\textbf{STA}}               & \multirow{2}{*}{\textbf{CS}}                 & \multirow{2}{*}{\textbf{WO}} & \multirow{2}{*}{\textbf{PPL}} & \multirow{2}{*}{\textbf{STA}} & \multirow{2}{*}{\textbf{CS}} & \multirow{2}{*}{\textbf{WO}} & \multirow{2}{*}{\textbf{PPL}} \\
			                                               &                                             &                                              &                              &                               &                               &                              &                              &                               \\
			\hline\hline
			Style-Embedding \cite{fu2018style} & 0.18                                        & \textbf{0.96}                                & \textbf{0.67}                & 124                           & \ 0.40$^\dag$                 & \ 0.93$^\dag$                & 0.36                         & \textbf{32}                   \\ \hline
			Cross-Alignment \cite{shen2017style}           & \ 0.78$^\dag$                               & 0.89                                         & 0.21                         & 93                            & 0.61                          & 0.89                         & 0.02                         & 202                           \\ \hline
			Multi-Decoder \cite{zhao2018adversarially}     & \ 0.82$^\dag$                               & 0.88                                         & 0.27                         & 85                            & 0.55                          & 0.93                         & 0.17                         & 75                            \\ \hline
			Del-Ret-Gen \cite{li2018delete} $^\ddag$       & 0.86                                        & 0.94                                         & 0.52                         & 70                            & 0.43                          & \textbf{0.98}                & \textbf{0.80}                & 65                            \\ \hline
			BackTranslate \cite{prabhumoye2018style}       & 0.85                                        & 0.83                                         & 0.08                         & 206                           & \textbf{0.83}                 & 0.82                         & 0.02                         & 115                           \\ \hline
			Cycle-RL \cite{xu2018unpaired} $^\ddag$        & 0.80                                        & 0.92                                         & 0.43                         & 470                           & 0.72                          & 0.91                         & 0.22                         & 332                           \\ \hline\hline
			Ours (DAE)                                     & 0.88                                        & 0.92                                         & 0.55                         & 137                           & 0.72                          & 0.92                         & 0.35                         & 73                            \\ \hline
			Ours (VAE)                                     & \textbf{0.93}                               & 0.90                                         & 0.47                         & \textbf{69}                   & 0.82                          & 0.90                         & 0.20                         & 63                            \\ \hline
		\end{tabular}}
		\vspace{-.2cm}
...
\begin{table}[!t]
	...
	\resizebox{\linewidth}{!}{
		\begin{tabular}{|l||c|c|c|}
			\hline
			\tabc{2}{Model}               & \multirow{2}{*}{\textbf{TS}} & \multirow{2}{*}{\textbf{CP}} & \multirow{2}{*}{\textbf{LQ}} \\
			                              &                              &                              &                              \\
			\hline \hline
