...
We show t-SNE plots~\cite{xxx} of both the deterministic autoencoder (DAE) and the variational autoencoder (VAE) models in Figure~\ref{fig:tsne-plots}.
...
\begin{table*}[!t]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{|l||c|c|c|c|c||c|c|c|c|c| }
			...
			Del-Ret-Gen \cite{li2018delete} $^\ddag$   & 0.86                                        & \textbf{0.94}                                & 0.52              & 70               & \textbf{0.19}     & \color{gray}0.43           & \color{gray} 0.98          & \color{gray} 0.80 & \color{gray} 65 & \color{gray} \textbf{0.17} \\ \hline
			...
			Ours (DAE)                                 & 0.88                                        & 0.92                                         & \textbf{0.55}     & 137              & 0.15              & 0.72                       & 0.92                       & \textbf{0.35}              & 73              & \textbf{0.15}     \\ \hline
...
{\color{red} Here, we exclude both stopwords and sentiment words.}
...
\begin{table*}[ht]
 	...
 	\begin{tabular}{| l || c | c | c | c | c |}
 		...
 		\tabc{2}{Objectives}                                                            & \multirow{2}{*}{\textbf{STA}} & \multirow{2}{*}{\textbf{CS}} & \multirow{2}{*}{\textbf{WO}} & \textbf{GM}       & \multirow{2}{*}{\textbf{PPL}} \\
 		                                                                                &                               &                              &                              & \textbf{(STA,WO)} &                               \\
 		\hline\hline
 		$\loss{AE}$                                                                     & 0.11                          & \textbf{0.94}                & \textbf{0.47}                         & 0.22              & 40                            \\ \hline
