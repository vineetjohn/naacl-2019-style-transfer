...
\begin{table*}[!t]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{|l||c|c|c|c||c|c|c|c| }
			\hline
			\tabc{2}{Model}                            & \multicolumn{4}{c||}{\textbf{Yelp Dataset}} & \multicolumn{4}{c|}{\textbf{Amazon Dataset}}                                                                                               \\ \cline{2-9}
			                                           & \textbf{STA}                                & \textbf{CS}                                  & \textbf{WO}   & \textbf{PPL} & \textbf{STA}  & \textbf{CS}   & \textbf{WO}   & \textbf{PPL} \\
			\hline\hline
