...
We use the geometric mean to compute an aggregate score over multiple evaluation metrics as shown in Tables \ref{tab:comparison-previous}, \ref{tab:manual-evaluation} and \ref{tab:ablation-results}.
