	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{|l||c|c|c|c|c||c|c|c|c|c| }
			...
			\tabc{2}{Model}                            & \multicolumn{5}{c||}{\textbf{Yelp Dataset}} & \multicolumn{5}{c|}{\textbf{Amazon Dataset}}                                                                                               \\ \cline{2-11}
			                                           & \textbf{STA}                                & \textbf{CS}                                  & \textbf{WO}   & \textbf{PPL} & \textbf{GO} & \textbf{STA}  & \textbf{CS}   & \textbf{WO}   & \textbf{PPL} & \textbf{GO}\\
			\hline\hline
			Style-Embedding \cite{fu2018style}    & \color{gray}0.18                    & \color{gray}\textbf{0.96}    &\color{gray} \textbf{0.67} &\color{gray} 124  &\color{gray}   xxx     & \color{gray} \ 0.40$^\dag$ &\color{gray} \ 0.93$^\dag$ &\color{gray} 0.36 &\color{gray} \textbf{32} & xxx  \\ \hline
			Cross-Alignment \cite{shen2017style}       & \ 0.78$^\dag$                               & 0.89                                         & 0.21          & 93   & xxx       & 0.61          & 0.89          & 0.02          & 202  & xxx    \\ \hline
			Multi-Decoder \cite{zhao2018adversarially} & \ 0.82$^\dag$                               & 0.88                                         & 0.27          & 85     & xxx      & 0.55         & \textbf{0.93}     & 0.17          & 75       &xxx  \\ \hline
			Del-Ret-Gen \cite{li2018delete} $^\ddag$   & 0.86  & \textbf{0.94}  & 0.52          & 70 & xxx  & \color{gray}0.43          & \color{gray}\textbf{0.98} & \color{gray}\textbf{0.80} & \color{gray}65         & xxx  \\ \hline
			BackTranslate \cite{prabhumoye2018style}   & 0.85                                        & 0.83                                         & 0.08          & 206    & xxx      & \textbf{0.83} & 0.82          & 0.02          & 115  & xxx  \\ \hline
			Cycle-RL \cite{xu2018unpaired} $^\ddag$    & 0.80                                        & 0.92                                         & 0.43          & 470    & xxx      & 0.72          & 0.91          & \textbf{0.22}          & 332  & xxx        \\ \hline\hline
			Ours (DAE)                                 & 0.88                                        & 0.92                                         & \textbf{0.55}          & 137    & xxx      & 0.72          & 0.92          & 0.35          & 73  & xxx         \\ \hline
			Ours (VAE)                                 & \textbf{0.93}                               & 0.90                                         & 0.47          & \textbf{69} & xxx & 0.82          & 0.90          & 0.20          & \textbf{63}      & xxx     \\ \hline
		\end{tabular}}
	\vspace{-.2cm}
