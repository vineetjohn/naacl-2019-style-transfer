...
\begin{table*}[!t]
	...
	\resizebox{\textwidth}{!}{
		\begin{tabular}{|l||c|c|c|c|c||c|c|c|c|c| }
			\hline
			\tabc{3}{Model}                                     & \multicolumn{5}{c||}{\textbf{Yelp Dataset}} & \multicolumn{5}{c|}{\textbf{Amazon Dataset}}                                                                                                                                                                                                                                      \\ \cline{2-11}
			                                                    & \multirow{2}{*}{\textbf{STA}}               & \multirow{2}{*}{\textbf{CS}}                 & \multirow{2}{*}{\textbf{WO}} & \textbf{GM}       & \multirow{2}{*}{\textbf{PPL}} & \multirow{2}{*}{\textbf{STA}} & \multirow{2}{*}{\textbf{CS}} & \multirow{2}{*}{\textbf{WO}} & \textbf{GM}       & \multirow{2}{*}{\textbf{PPL}} \\
			                                                    &                                             &                                              &                              & \textbf{(STA,WO)} &                               &                               &                              &                              & \textbf{(STA,WO)} &                               \\
			\hline\hline
			Style-Embedding \cite{fu2018style}                  & 0.18                                        & \textbf{0.96}                                & \textbf{0.67}                & 0.35              & 124                           & \ 0.40$^\dag$                 & \ 0.93$^\dag$                & 0.36                         & 0.39              & \textbf{32}                   \\ \hline
			Cross-Alignment \cite{shen2017style}                & \ 0.78$^\dag$                               & 0.89                                         & 0.21                         & 0.41              & 93                            & 0.61                          & 0.89                         & 0.02                         & 0.12              & 202                           \\ \hline
			Multi-Decoder \cite{zhao2018adversarially}          & \ 0.82$^\dag$                               & 0.88                                         & 0.27                         & 0.48              & 85                            & 0.55                          & 0.93                         & 0.17                         & 0.31              & 75                            \\ \hline
			Del-Ret-Gen \cite{li2018delete} $^\ddag$ & 0.86                                        & 0.94                                         & 0.52                         & 0.67              & 70                            & 0.43                          & \textbf{0.98}                & \textbf{0.80}                & \textbf{0.58}     & 65                            \\ \hline
...
We use the geometric mean to compute an aggregate score over multiple evaluation metrics as shown in Tables \ref{tab:comparison-previous} and \ref{tab:manual-evaluation}.
%  and \ref{tab:ablation-results}.
...
\begin{table}[!t]
	...
	\resizebox{\linewidth}{!}{
		\begin{tabular}{|l||c|c|c||c|}
			\hline
			\tabc{2}{Model}               & \multirow{2}{*}{\textbf{TS}} & \multirow{2}{*}{\textbf{CP}} & \multirow{2}{*}{\textbf{LQ}} & \textbf{GM}         \\
			                              &                              &                              &                              & \textbf{(TS,CP,LQ)} \\
			\hline \hline
			\citet{fu2018style}           & 1.67                         & \textbf{3.84}                & 3.66                         & 2.86                \\ \hline
			...
			Ours (VAE)                    & \textbf{4.32}                & 3.73                         & \textbf{4.48}                & \textbf{4.16}       \\ \hline
		\end{tabular}}
...
For baseline methods, we quoted results from existing papers whenever possible, and replicated the experiments to report other metrics with publicly available code \cite{shen2017style,fu2018style,zhao2018adversarially}.\footnote{\citet{fu2018style} propose another model using multiple decoders; the method is further developed in \citet{zhao2018adversarially}, and we adopt the latter for comparison.} As discussed in Table~\ref{tab:comparison-previous}, our replication involves reasonable efforts and is fair for comparison.
...
Table~\ref{tab:manual-evaluation} presents the results of human evaluation. Again, we see that the style embedding model \cite{fu2018style} is ineffective as it has a very low transfer strength, and that our method outperforms other baselines in all aspects. The results are consistent with the automatic metrics in both experiments (Table~\ref{tab:comparison-previous}). This implies that the automatic metrics we used are reasonable; it also shows consistent evidence of the effectiveness of our approach.
